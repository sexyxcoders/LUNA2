...
from Alya.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Alya import Carbon, app
from Alya.utils.decorators.language import language, languageCB
from Alya.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
from Alya.utils.pastebin import ANNIEBIN
import time
import yt_dlp
...
from Alya.utils.stream.stream import stream
from typing import Dict, List, Union

from Alya.core.mongo import mongodb
...
@app.on_callback_query(filters.regex("alya_playlist") & ~BANNED_USERS)
@languageCB
async def add_playlist(client, CallbackQuery, _):
    callback_data = CallbackQuery.data.strip()
    videoid = callback_data.split(None, 1)[1]

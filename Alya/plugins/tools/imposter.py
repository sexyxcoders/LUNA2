...
from Alya.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://files.catbox.moe/l0nyxg.jpg", caption=msg)
